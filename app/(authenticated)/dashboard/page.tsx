    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-white/40 text-sm mt-1">Your contribution overview</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/graph-editor"
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-neon-green-500/10 border border-neon-green-500/20 text-neon-green-400 hover:bg-neon-green-500/20 transition-colors text-sm font-medium group"
          >
